export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      {/* Side vignette */}
      <div className="absolute inset-0 bg-gradient-to-r from-ink/40 via-ink/10 to-ink/40" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex items-center justify-center gap-4 mb-6">
          ...
          <span className="text-gold/90 text-xs tracking-[0.3em] uppercase font-medium">
        ...
        <p className="text-lg sm:text-xl md:text-2xl text-parchment font-serif-body italic mb-4 leading-relaxed drop-shadow-[0_1px_6px_rgba(0,0,0,0.9)]">
          "Pull up a chair — I've got worlds to show you."
        </p>

        <p className="text-base sm:text-lg text-parchment/95 max-w-2xl mx-auto mb-10 leading-relaxed drop-shadow-[0_1px_4px_rgba(0,0,0,0.9)]">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          <button
            ...
            className="px-8 py-4 border border-parchment/40 text-parchment/95 font-medium text-sm tracking-widest uppercase rounded-sm hover:border-gold/60 hover:text-gold transition-all duration-300"
          >
            About Alexander
          </button>
        </div>
